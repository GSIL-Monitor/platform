...
@MapperScan(basePackages = "cn.laeni.platform.ossfile.mapper", sqlSessionTemplateRef = "dbmybatisSqlSessionTemplate")
public class MyBatisConfig {
    ...
    public SqlSessionFactory testSqlSessionFactory(@Qualifier("ossdataSource") DataSource dataSource)
        ...
        // 映射文件路径(可以使用通配符)
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:cn.laeni.platform.ossfile.mapper/*.xml"));
    ...
    public MapperScannerConfigurer getMapperScannerConfigurer(){
        ...
        // 扫描映射接口所在位置
        mapperScannerConfigurer.setBasePackage("cn.laeni.platform.ossfile.mapper");
        // 告诉Spring扫描到的接口交给哪个SqlSessionFactory使用
        mapperScannerConfigurer.setSqlSessionFactoryBeanName("dbmybatisSqlSessionFactory");
