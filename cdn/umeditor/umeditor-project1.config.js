...
(function () {
    /* 编辑器资源文件根路径(仅仅是编辑器的资源路径,可以不在服务器上) */
	window.UMEDITOR_HOME_URL = "https://chengdu-1252266447.cos.ap-chengdu.myqcloud.com/ueditor/";
    var URL = UMEDITOR_HOME_URL,
	/* 后端请求地址 */
	URL_SERVER = "https://project1.laeni.cn/",
	//图片修正地址,即上传成功后返回一个不完整的URL图片地址,将该地址与本地址拼接后成为完整的img地址
	URL_IMGEPATH = "https://chengdu-1252266447.cos.ap-chengdu.myqcloud.com/";
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL_SERVER+"imageUp.do"		//图片上传提交地址
        ,imagePath:URL_IMGEPATH					//图片修正地址
        ,imageFieldName:"upfile"				//图片数据的key,即后端通过什么键才能获取到上传的文件
